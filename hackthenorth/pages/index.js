          ...
          {session && (
            <>
              <h1 className={styles.title}>
                ...
                {session.user.name.split(" ", 1) ?? session.user.email}.
              </h1>
            </>
          )}
          {!session && (
            <>
              <h1 className={styles.title}>Welcome to ShareFood!</h1>
              <Link href="/SignIn">
                <a>
                  <em>It looks like you might be new here. Sign in here.</em>
                </a>
              </Link>
            </>
          )}
          ...
          <div className={styles.grid}>
            <Link href="/featured-posts">
              <a className={styles.card}>
                ...
                <p>
                  Checkout today's featured meals by our favourite contributors.
                </p>
              </a>
            </Link>
            ...
            <a href="/ourTeam" className={styles.card}>
              <h3>Our Team &rarr;</h3>
            ...
            >
              ...
              <p>Checkout the code that makes our mission possible.</p>
            </a>
          </div>
